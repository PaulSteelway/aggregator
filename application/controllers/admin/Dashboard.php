...
class Dashboard extends Admin_Controller {
    ...
    function index()
    {
			...
			$transactions = $this->transactions_model->get_pending_dash($_SESSION['user']['id']);

			$disputes = $this->disputes_model->get_pending_dash($_SESSION['user']['id']);

			$tickets = $this->support_model->get_pending_dash($_SESSION['user']['id']);

			$verification = $this->verification_model->get_pending_dash($_SESSION['user']['id']);

			$merchants = $this->merchants_model->get_pending_dash($_SESSION['user']['id']);
